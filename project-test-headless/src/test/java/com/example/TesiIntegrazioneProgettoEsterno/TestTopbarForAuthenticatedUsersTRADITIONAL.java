...
public class TestTopbarForAuthenticatedUsersTRADITIONAL {
  ...
  @Test
  public void testTopbarForAuthenticatedUsers_release_0_0_1() throws Exception {
    ...
    isElementPresent(By.linkText("Orders"));
