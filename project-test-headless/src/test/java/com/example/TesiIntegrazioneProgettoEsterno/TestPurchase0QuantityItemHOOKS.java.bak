...
private static StringBuffer verificationErrors = new StringBuffer();
	  ...
	  public void setUp() throws Exception {
		  ...
		  options.addArguments("--headless", "--disable-gpu", "--window-size=4500,3200","--no-sandbox","--ignore-certificate-errors");
  ...
  @Test
  public void testPurchase0QuantityItem_loc_Hooks_release_0_0_1() throws Exception {
