...
public class TestSignupWithNoNumberPasswordTRADITIONAL {
  ...
  @Test
  public void testSignupWithNoNumberPassword_release_0_0_1() throws Exception {
    ...
    driver.findElement(By.id("passwordInput")).sendKeys("testttttt");
    driver.findElement(By.xpath("//button[@type='submit']")).click();
    isElementPresent(By.cssSelector("div.alert.alert-danger > ul > li"));
  }
